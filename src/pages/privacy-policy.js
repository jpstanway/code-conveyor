...
const PrivacyPolicyPage = () => (
  <Layout>
    ...
    <address>
      ...
      <br />
      codeconveyor@gmail.com
      <br />
    </address>
    <p>
      It is Code Conveyor's policy to respect your privacy regarding any
      information we may collect while operating our website. This Privacy
      Policy applies to{" "}
      <a href="https://www.codeconveyor.com">https://www.codeconveyor.com</a>{" "}
      (hereinafter, "us", "we", or "https://www.codeconveyor.com"). We respect
    ...
    <p>
      Like most website operators, Code Conveyor collects
      ...
      Code Conveyor's purpose in collecting non-personally identifying
      information is to better understand how Code Conveyor's visitors use its
      website. From time to time, Code Conveyor may release
      non-personally-identifying information in the aggregate, e.g., by
      publishing a report on trends in the usage of its website.
    </p>
    <p>
      Code Conveyor also collects potentially personally-identifying information
      like Internet Protocol (IP) addresses for logged in users and for users
      leaving comments on https://www.codeconveyor.com blog posts. Code Conveyor
    ...
    <p>
      Certain visitors to Code Conveyor's websites choose to interact with Code
      Conveyor in ways that require Code Conveyor to gather
      personally-identifying information. The amount and type of information
      that Code Conveyor gathers depends on the nature of the interaction. For
      example, we ask visitors who sign up for a blog at
      https://www.codeconveyor.com to provide a username and email address.
    </p>
    <h2>Security</h2>
    <p>
    ...
    <p>
      ...
      Privacy Policy covers the use of cookies by Code Conveyor and does not
    ...
    <p>
      Code Conveyor discloses potentially personally-identifying and
      personally-identifying information only to those of its employees,
      contractors and affiliated organizations that (i) need to know that
      information in order to process it on Code Conveyor's behalf or to provide
      services available at Code Conveyor's website, and (ii) that have agreed
      ...
      using Code Conveyor's website, you consent to the transfer of such
      information to them. Code Conveyor will not rent or sell potentially
      ...
      described above, Code Conveyor discloses potentially
      ...
      Code Conveyor believes in good faith that disclosure is reasonably
      necessary to protect the property or rights of Code Conveyor, third
      parties or the public at large.
    </p>
    <p>
      If you are a registered user of https://www.codeconveyor.com and have
      supplied your email address, Code Conveyor may occasionally send you an
      email to tell you about new features, solicit your feedback, or just keep
      you up to date with what's going on with Code Conveyor and our products.
      ...
      to your request or to help us support other users. Code Conveyor takes all
    ...
    <p>
      Code Conveyor may collect statistics about the behavior of visitors to its
      website. Code Conveyor may display this information publicly or provide it
      to others. However, Code Conveyor does not disclose your
      personally-identifying information.
    </p>
    ...
    <h2>Cookies</h2>
    <p>
      To enrich and perfect your online experience, Code Conveyor uses
    ...
    <p>
      ...
      the visitor returns. Code Conveyor uses cookies to help Code Conveyor
      identify and track visitors, their usage of https://www.codeconveyor.com,
      and their website access preferences. Code Conveyor visitors who do not
      wish to have cookies placed on their computers should set their browsers
      to refuse cookies before using Code Conveyor's websites, with the drawback
      that certain features of Code Conveyor's websites may not function
      properly without the aid of cookies.
    </p>
    <p>
      By continuing to navigate our website without changing your cookie
      settings, you hereby acknowledge and agree to Code Conveyor's use of
      cookies.
    </p>
    <h2>Privacy Policy Changes</h2>
    <p>
      Although most changes are likely to be minor, Code Conveyor may change its
      Privacy Policy from time to time, and in Code Conveyor's sole discretion.
      Code Conveyor encourages visitors to frequently check this page for any
    ...
    <p>
      ...
      via <a href="mailto:codeconveyor@gmail.com">email</a> or{" "}
      <a href="tel:7787910954">phone</a>.
    </p>
  </Layout>
)
