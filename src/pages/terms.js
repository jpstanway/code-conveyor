...
const TermsAndConditionsPage = () => (
  <Layout>
    ...
    <h2>Welcome to Code Conveyor</h2>
    <p>
      These terms and conditions outline the rules and regulations for the use
      of Code Conveyor's Website.
    </p>{" "}
    <br />
    <span style={{ textTransform: "capitalize" }}> Code Conveyor</span> is
    located at:
    <br />
    <address>
    ...
    <p>
      ...
      in full. Do not continue to use Code Conveyor's website if you do not
    ...
    <p>
      ...
      accordance with and subject to, prevailing law of Canada. Any use of the
    ...
    <h2>Cookies</h2>
    <p>
      We employ the use of cookies. By using Code Conveyor's website you consent
      to the use of cookies in accordance with Code Conveyor's privacy policy.
    </p>
    <p>
    ...
    <h2>License</h2>
    <p>
      Unless otherwise stated, Code Conveyor and/or it's licensors own the
      intellectual property rights for all material on Code Conveyor. All
      intellectual property rights are reserved. You may view and/or print pages
      from https://www.codeconveyor.com for your own personal use subject to
      restrictions set in these terms and conditions.
    </p>
    <p>You must not:</p>
    <ol>
      <li>Republish material from https://www.codeconveyor.com</li>
      <li>
        Sell, rent or sub-license material from https://www.codeconveyor.com
      </li>
      <li>
        Reproduce, duplicate or copy material from https://www.codeconveyor.com
      </li>
    </ol>
    <p>
      Redistribute content from Code Conveyor (unless content is specifically
    ...
    <ol>
      ...
      <li>
        ...
        areas of the website. Code Conveyor does not screen, edit, publish or
        review Comments prior to their appearance on the website and Comments do
        not reflect the views or opinions ofCode Conveyor, its agents or
        ...
        Code Conveyorshall not be responsible or liable for the Comments or for
      ...
      <li>
        Code Conveyorreserves the right to monitor all Comments and to remove
      ...
      <li>
        You hereby grant to <strong>Code Conveyor</strong> a non-exclusive
    ...
    <p>
      ...
      visibility associated with the hyperlink outweighs the absence of Code
      Conveyor; and (d) where the link is in the context of general resource
    ...
    <p>
      ...
      e-mail to{" "}
      <a
        href="mailto:codeconveyor@gmail.com"
        title="send an email to codeconveyor@gmail.com"
      >
    ...
    <p>
      No use of Code Conveyor's logo or other artwork will be allowed for
